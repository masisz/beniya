...
class TestTextUtils < Minitest::Test
  ...
  def test_display_width_ascii
    ...
    assert_equal 11, Beniya::TextUtils.display_width('hello world')  # 'hello world' は11文字
  ...
  def test_truncate_to_width_japanese
    # 日本語文字列の切り詰め
    result = Beniya::TextUtils.truncate_to_width('こんにちは', 5)
    # 幅5で切り詰める: 'こ'(2) + '...'(3) = 5
    assert_equal 'こ...', result

    result = Beniya::TextUtils.truncate_to_width('こんにちは', 8)
  ...
  def test_truncate_to_width_mixed
    # 混在文字列の切り詰め
    result = Beniya::TextUtils.truncate_to_width('hello世界', 8)
    # hello(5) + '...'(3) = 8
    assert_equal 'hello...', result
  end
  ...
  def test_pad_string_to_width_padding_needed
    ...
    assert_equal 10, Beniya::TextUtils.display_width(result)
  ...
  def test_pad_string_to_width_mixed
    ...
    assert_equal 15, Beniya::TextUtils.display_width(result)
  end
