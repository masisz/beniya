...
class TestPlugin < Minitest::Test
  def setup
    ...
    if defined?(Beniya::PluginManager)
  ...
  def test_plugin_base_class_exists
    assert defined?(Beniya::Plugin), "Beniya::Plugin クラスが定義されていません"
  end

  def test_plugin_dependency_error_exists
    assert defined?(Beniya::Plugin::DependencyError), "Beniya::Plugin::DependencyError クラスが定義されていません"
  end
  ...
  def test_plugin_auto_registration_on_inheritance
    ...
    assert_includes Beniya::PluginManager.plugins, Beniya::Plugins::TestPlugin
  end
  ...
  def test_plugin_requires_name_method
    ...
    Beniya::Plugins.const_set(:TestPluginNoName, test_plugin)
    plugin = Beniya::Plugins::TestPluginNoName.new
  ...
  def test_plugin_default_description
    ...
    Beniya::Plugins.const_set(:TestPluginDefaultDesc, test_plugin)
    plugin = Beniya::Plugins::TestPluginDefaultDesc.new
  ...
  def test_plugin_custom_description
    ...
    Beniya::Plugins.const_set(:TestPluginCustomDesc, test_plugin)
    plugin = Beniya::Plugins::TestPluginCustomDesc.new
  ...
  def test_plugin_default_version
    ...
    Beniya::Plugins.const_set(:TestPluginDefaultVer, test_plugin)
    plugin = Beniya::Plugins::TestPluginDefaultVer.new
  ...
  def test_plugin_custom_version
    ...
    Beniya::Plugins.const_set(:TestPluginCustomVer, test_plugin)
    plugin = Beniya::Plugins::TestPluginCustomVer.new
  ...
  def test_plugin_default_commands
    ...
    Beniya::Plugins.const_set(:TestPluginDefaultCmd, test_plugin)
    plugin = Beniya::Plugins::TestPluginDefaultCmd.new
  ...
  def test_plugin_custom_commands
    ...
    Beniya::Plugins.const_set(:TestPluginCustomCmd, test_plugin)
    plugin = Beniya::Plugins::TestPluginCustomCmd.new
  ...
  def test_plugin_requires_gem_declaration
    ...
    Beniya::Plugins.const_set(:TestPluginRequires, test_plugin)
    assert_equal ['fileutils', 'yaml'], Beniya::Plugins::TestPluginRequires.required_gems
  end
  ...
  def test_plugin_dependency_check_with_missing_gems
    ...
    Beniya::Plugins.const_set(:PluginWithMissingDependencies, test_plugin)

    # 依存gemが不足している場合、DependencyErrorを投げる
    error = assert_raises(Beniya::Plugin::DependencyError) do
      Beniya::Plugins::PluginWithMissingDependencies.new
    end
  ...
  def test_plugin_dependency_error_message_includes_install_instructions
    ...
    Beniya::Plugins.const_set(:PluginWithMissingDependency, test_plugin)

    error = assert_raises(Beniya::Plugin::DependencyError) do
      Beniya::Plugins::PluginWithMissingDependency.new
    end
  ...
  def test_plugin_with_no_dependencies
    ...
    Beniya::Plugins.const_set(:TestPluginNoDeps, test_plugin)
