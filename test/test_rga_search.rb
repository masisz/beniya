...
require_relative '../lib/beniya/keybind_handler'
require_relative '../lib/beniya/directory_listing'
require_relative '../lib/beniya/file_opener'
require_relative '../lib/beniya/config_loader'
...
begin
  ...
  directory_listing = Beniya::DirectoryListing.new(Dir.pwd)
